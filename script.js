...
const unusedQuotes = ['And a step backward, after making a wrong turn, is a step in the right direction. <br/>- Kurt Vonnegut', 'Positivity, like any skill, you get better at by practicing it. <br/>- Jackson Bliton', 'All we have to decide is what to do with the time that is given us. <br/>- J.R.R. Tolkien', 'More is lost by indecision than wrong decision. <br/>- Cicero', "A ship is safe in harbor, but that's not what ships are for. <br/>- William Shedd",
    'We are what we repeatedly do. Excellence, then, is not an act, but a habit. <br/>- Anonymous', 'Calm seas make poor sailors. <br/>- Anonymous',
    ...
    'Everyone you meet is fighting a battle that you know nothing about. <br/>- Anonymous', 'To strive, to seek, to find, and not to yield. <br/>- Tennyson', 'Do or do not. There is no try. <br/>- Yoda',
